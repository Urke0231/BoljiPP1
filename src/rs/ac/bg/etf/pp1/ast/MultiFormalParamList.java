...
public class MultiFormalParamList extends FormParsList {

    private FormParsList FormParsList;
    private FormalParamDecl FormalParamDecl;

    public MultiFormalParamList (FormParsList FormParsList, FormalParamDecl FormalParamDecl) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("MultiFormalParamList(\n");

...
public class YesListaNastavaka extends ListaNastavaka {

    private Expr Expr;
    private ListaNastavaka1 ListaNastavaka1;

    public YesListaNastavaka (Expr Expr, ListaNastavaka1 ListaNastavaka1) {
        this.Expr=Expr;
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("YesListaNastavaka(\n");
